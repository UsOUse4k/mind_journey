            ...
            (failure) {
              showCommonSnackBar(
                ...
                message: failure.maybeMap(
                  emailAlreadyInUse: (_) => "Этот электронный адрес уже занят",
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: (_) =>
                          context.read<RegisterBloc>().state.name.value.fold(
                                (f) => f.maybeMap(
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: (_) =>
                          context.read<RegisterBloc>().state.surname.value.fold(
                                (f) => f.maybeMap(
                                  empty: (_) => "Поле не должно быть пустым",
                                  orElse: () => null,
                                ),
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: (_) =>
                          context.read<RegisterBloc>().state.email.value.fold(
                                (f) => f.maybeMap(
                                  invalidEmail: (_) =>
