...
class _$UserImpl extends _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, userId: $userId, email: $email, name: $name, surname: $surname)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, email, name, surname);
...
abstract class _User extends User {
  const factory _User(
      ...
      required final NotEmptyString surname}) = _$UserImpl;
